...
def main(cfg):
    ...
    tokenizer = AutoTokenizer.from_pretrained("McGill-NLP/Sheared-LLaMA-2.7B-weblinx", padding_side="left")
    ...
    model = AutoModelForCausalLM.from_pretrained("McGill-NLP/Sheared-LLaMA-1.3B-weblinx", **model_kwargs)
