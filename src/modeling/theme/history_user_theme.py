...
# dialogues_similarity_model = SentenceTransformer('all-MiniLM-L6-v2')
# dialogues_similarity_model = "we did not give model object"
...
# import pickle
# with open("user_themes", "wb") as fil:
#     pickle.dump(input_records, fil)
